...
#define COLOR15 @"d6503e"

#define ANNOU_TITLE_TEXT @"5B5E5D"
#define ANNOU_BIG_TEXT @"212121"
#define ANNOU_NORMAL_TEXT @"727272"
#define ANNOU_SMALL_TEXT @"B8B8B8"
#define ANNOU_LINE @"D8D8D8"


@implementation UIColor (CustomColor)

+ (UIColor *)annou_small_text
{
    return [self colorWithHexString:ANNOU_SMALL_TEXT alpha:1.0f];
}

+ (UIColor *)annou_line
{
    return [self colorWithHexString:ANNOU_LINE alpha:1.0f];
}

+ (UIColor *)annou_normal_text
{
    return [self colorWithHexString:ANNOU_NORMAL_TEXT alpha:1.0f];
}

+ (UIColor *)annou_big_text
{
    return [self colorWithHexString:ANNOU_BIG_TEXT alpha:1.0f];
}

+ (UIColor *)annou_title_text
{
    return [self colorWithHexString:ANNOU_TITLE_TEXT alpha:1.0f];
}
